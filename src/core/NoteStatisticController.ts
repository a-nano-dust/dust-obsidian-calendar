...
export default class NoteStatisticController {
    ...
    public static MAX_DOTS_NUM: number = 5;
    ...
    private async executeStaticByFile(file: TAbstractFile | null): Promise<void> {
        ...
        newNoteStatistic.totalDots = Math.ceil((totalWords + 1) / 200);
        if (newNoteStatistic.totalDots >= NoteStatisticController.MAX_DOTS_NUM) {
            newNoteStatistic.totalDots = NoteStatisticController.MAX_DOTS_NUM;
        }
